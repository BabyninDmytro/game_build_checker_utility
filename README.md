...
Вона допомагає знаходити та видаляти невикористовувані ресурси, а також підтримувати порядок у текстових файлах.

Інструмент використовується як частина внутрішнього пайплайну.

🔹 Основні можливості
Утиліта містить 4 вкладки:

1️⃣ Search unused layers
Пошук і видалення невикористовуваних зображень (layers) у проєкті.
Аналізує сцени
Показує файли, які не використовуються

Дає змогу швидко відкрити або видалити файл

2️⃣ Search unused sounds
Пошук і видалення невикористовуваних звукових файлів.
Відображає список зайвих аудіоресурсів
Дає змогу швидко відкрити або видалити файл

3️⃣ Search duplicate values in texts
Пошук дублікатів значень ключів у текстових / локалізаційних файлах.
Показує тексти з однаковими значеннями
Дозволяє обрати основний ключ

4️⃣ Search unused items
Пошук і видалення невикористовуваних предметів (items) у грі.
Показує предмети, які не використовуються
Дає змогу швидко відкрити або видалити предмет
